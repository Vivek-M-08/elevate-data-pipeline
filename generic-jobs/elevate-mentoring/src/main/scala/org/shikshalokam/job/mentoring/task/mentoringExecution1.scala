...
import org.shikshalokam.job.mentoring.functions.{mentoringFunction1}

import java.util.Properties

class mentoringExecution1(table_name: String, script_type: String) extends mentoringFunction1 {
...
object mentoringExecution1 {
  def main(args: Array[String]): Unit = {
    ...
    val app = new mentoringExecution1(table_name, script_type)
    // Run the application
    app.process()
